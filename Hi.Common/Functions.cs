...
namespace Common
{
    public class Functions
    {
        ...
        /// <summary>
        /// alert 和 window.location
        /// </summary>
        /// <param name="str">alert内容</param>
        /// <param name="url">转向地址。空字符串为不转向</param>
        /// <param name="writeEnd">是否输出End()</param>
        ...
        #region ==传递参数 string transParameters(string Para) Para代表不传递的参数，用 || 分隔==
        /// <summary>
        /// 自动传递地址栏参数。地址栏：.aspx?id=1＆n=abc＆page=5＆s=def -- func.transParameters("n||s")的返回值：id=1＆page=5
        /// </summary>
        /// <param name="Para">不传递的参数名</param>
        ...
        #region ==判断字符串长度 int strLength(string text)==
        /// <summary>
        ...
        #region ==保存上传文件路径 public bool save_url(string content)==
        /// <summary>
        /// 使用编辑器的字段，添加新纪录时使用。KE编辑器暂时不用呢
        /// </summary>
        ...
        #region ==删除特定上传文件 bool del_url(string content)==
        /// <summary>
        /// 使用编辑器的字段，删除纪录时使用。KE编辑器暂时不用呢。
        /// </summary>
        ...
        public static bool del_other(int start)
        {
            ...
            */
            ...
            //HttpContext.Current.Response.Write("<script language=\"javascript\">alert(\"垃圾文件已被删除\");window.navigate(\"space.aspx\");</script>");
        ...
        #region ==更新文件路径 bool update_url(string news,string old)==
        /// <summary>
        /// 使用编辑器的字段，更新纪录时使用。
        /// </summary>
        ...
        #region 将两个datatable拆分成两个datatable    按奇数偶数行拆分
        ...
        /// 服务器端异步传输
        /// </summary>
        /// <param name="url">服务器端处理页面地址。http全路径，可以带地址栏参数</param>
        ...
        /// </summary>
        /// <param name="txtFileName">要将图片保存的路径</param>
        ...
        #region ==验证逗号分隔的多主键均为合法long类型数字==
        /// <summary>
        /// 验证逗号分隔的多主键均为合法long类型数字
        /// </summary>
        /// <param name="pk">逗号分隔的多主键字符串</param>
        ...
        /// 根据缓存查询列表
        /// </summary>
        /// <param name="model">所属表类型</param>
        /// <param name="orders">所有查询项</param>
        /// <param name="obj">将缓存里的泛型转为object类型</param>
        ...
        /// 动态编译
        /// </summary>
        /// <param name="eval_str">要执行的动态编译的字符串</param>
        /// <param name="objs">动态编译所执行方法需要的参数集合</param>
        /// <param name="dll">动态编译所需要的dll文件（根目录Bin文件里有的）</param>
        public static object DoCompile(string eval_str, object[] objs,string[] dll)
        {
            ...
            {
                objCompilerParameters.ReferencedAssemblies.Add(HttpContext.Current.Server.MapPath("/" + Common.Para.siteHead + dll[i]));//引用dll  
            }
            ...
            {
                HttpContext.Current.Response.Write("编译错误：");
